...
inner join main_rdv.link_rdv__medical_center_revenue_pmu l_med_rev on h_rev.revenue_hk = l_med_rev.revenue_hk
...
inner join main_rdv.link_rdv__value_pmu_type_revenue l_vtype_rev on h_rev.revenue_hk = l_vtype_rev.revenue_hk
