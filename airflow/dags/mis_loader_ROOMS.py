...
dag =  DAG('mis_loader_ROOMS'
           ...
           , params={
        "topic_name_param": 'sys__mis__esud_rzdm._opt_esud_esud_99099.fdb.ROOMS'  # Значение по умолчанию, которое будет выводиться в UI при триггере
...
fetch_data_from_kafka = PythonOperator(
    ...
    op_args = ['sys__mis__esud_rzdm._opt_esud_esud_99099.fdb.ROOMS'],
    dag=dag,
)
