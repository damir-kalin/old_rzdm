...
dag =  DAG('mis_loader_H_SCHEDULE'
        ...
        , "suffix_tbl_mart_lr_name_param": '_hstat'        
    },
    )
...
fetch_data_from_kafka = PythonOperator(
    ...
    op_args = ['sys__mis__esud_rzdm._opt_esud_esud_99099.fdb.H_SCHEDULE'],
    dag=dag,
)
...
upload_to_mart = PythonOperator(
    ...
    op_args = ['unverified_mart', 'medical__dm_', '_hstat'],
    dag=dag,
)
