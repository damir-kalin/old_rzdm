...
public class KpiPipline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> source = KafkaSource.<String>builder()
                ...
                .setTopics("sys__kuirzp__esud_rzdm__kpi__data")
                .setGroupId("flink-kpi-consumer-group")
        ...
        env.execute("Kpi Streaming Pipeline");
    }
    ...
    private static StreamExecutionEnvironment createExecutionEnvironment() {
        ...
        env.configure(config, KpiPipline.class.getClassLoader());
